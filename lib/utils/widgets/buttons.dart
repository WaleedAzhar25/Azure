...
class PrimaryButton extends StatelessWidget {
   const PrimaryButton({Key? key, required this.text, required this.buttonColor, required this.onTap, required this.textColor, required this.borderColor, this.radius=12, this.textSize=18,  this.contentPadding=16}) : super(key: key);
  final String text;
